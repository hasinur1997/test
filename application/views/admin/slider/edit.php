      ...
      <div class="span6">
        ...
        <div class="widget-box">
              ...
              <div class="widget-content nopadding">
                ...
                <form action="<?php echo base_url('slider/update?id='.$edit->id)?>" method="POST" class="form-horizontal" enctype="multipart/form-data" >
                  ...
                  <div class="control-group<?php echo form_error('title') ? ' has-error' : ''?>">
                    ...
                    <div class="controls">
                      ...
                      <input type="text" name="title" id="title" class="span11" value="<?php echo $edit->title?>">
                  ...
                  <div class="control-group<?php echo form_error('description') ? ' has-error' : ''?>">
                    ...
                    <div class="controls">
                      ...
                      <textarea name="description" id="description" cols="30" rows="7" class="span11"><?php echo $edit->description?></textarea>
                  ...
                  <div class="thumbnail"> 
                    <img src="<?php echo base_url('uploads/'.$edit->image)?>" alt="">
                  </div>
